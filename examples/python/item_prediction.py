...
training_data = IO.ItemRecommenderData.Read("u1.base", user_mapping, item_mapping)
...
print Eval.ItemPredictionEval.Evaluate(recommender, test_data, training_data, relevant_items)
