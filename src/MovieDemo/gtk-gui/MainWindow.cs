...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		this.UIManager.AddUiFromString ("<ui><menubar name='menubar1'><menu name='FilterAction' action='FilterAction'><menuitem name='OnlyShow200MostPopularMoviesAction' action='OnlyShow200MostPopularMoviesAction'/><menu name='ByGenreAction' action='ByGenreAction'><menuitem name='ActionAction' action='ActionAction'/></menu></menu><menu name='LanguageAction' action='LanguageAction'><menuitem name='EnglishAction' action='EnglishAction'/><menuitem name='DeutschAction' action='DeutschAction'/></menu><menu name='UserAction' action='UserAction'><menuitem name='SaveRatingsAnonymouslyAction' action='SaveRatingsAnonymouslyAction'/><menuitem name='DiscardRatingsAction' action='DiscardRatingsAction'/><menu name='LoadUserAction' action='LoadUserAction'><menuitem name='AndrAction' action='AndrAction'/><menuitem name='ArtusAction' action='ArtusAction'/><menuitem name='ChristophAction' action='ChristophAction'/><menuitem name='LucasAction' action='LucasAction'/><menuitem name='KrisztianAction' action='KrisztianAction'/><menuitem name='NgheAction' action='NgheAction'/><menuitem name='OsmanAction' action='OsmanAction'/><menuitem name='RasoulAction' action='RasoulAction'/><menuitem name='SabrinaAction' action='SabrinaAction'/><menuitem name='TomasAction' action='TomasAction'/><menuitem name='ZenoAction' action='ZenoAction'/></menu></menu></menubar></ui>");
